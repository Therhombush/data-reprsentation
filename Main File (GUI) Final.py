...
# Please enter database details at line 119 & 120.
...
def easterEgg():
  ...
  def jk():
    ...
    bundle = ['joke1','joke2','Joke3','Joke4'] #Jokes

    jokeline = Text(eastegg, height=2,width=59, font=("Bahnschrift SemiLight Condensed",18), bg='#e6ffff', borderwidth=0)
